const RULES = {
    ...
    JavaScript: [
        {
            Name: 'Keyword',
            Regex: /if|else|for|while|do|switch|case|break|continue|default|try|catch|finally|throw|function|return|var|let|const|class|extends|super|import|export|new|this|typeof|instanceof|void|delete|in|of|as|from|static|get|set|enum|implements|interface|package|private|protected|public|with|abstract|boolean|byte|char|double|final|float|goto|int|long|native|short|synchronized|throws|transient|volatile|async|await|yield|debugger|null|undefined|true|false|Math|Object|Array|String|Number|Boolean|Date|RegExp|Error|Promise|JSON|console|window|document/,
            Style: {
                Color: '#569CD6',
                Bold: false,
                Italic: false,
